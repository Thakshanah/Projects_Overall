...
CREATE TABLE `customer_contact_number` (
  ...
  CONSTRAINT `customer_contact_number_ibfk_1` FOREIGN KEY (`Customer_ID`) REFERENCES `customer` (`Customer_ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `customer_contact_number` VALUES ('C1','+94788774812'),('C3','0712223473'),('C4','+92788774816'),('C5','0788774815');
